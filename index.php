								...
								<form method="post" action="tarefa_controller.php?acao=ordenarPor" id="formOrdenar">
									...
									<div>
										<button type="button" class="btn btn-danger"
											onclick="ordenarPor('tarefa')">Nome</button>
										<button type="button" class="btn btn-danger"
											onclick="ordenarPor('data_cadastrado')">Data de Criação</button>
										<button type="button" class="btn btn-danger"
											onclick="ordenarPor('id_status')">Status</button>
										<button type="button" class="btn btn-danger"
											onclick="ordenarPor('id_categoria')">Categoria</button>
									</div>
								</form>
							</div>
